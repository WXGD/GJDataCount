...
/** 分割线颜色(DD,DD,DD) */
#define lineColor [UIColor colorWithRed:221 / 254.0 green:221 / 254.0 blue:221 / 254.0 alpha:1]
...
- (void)customCellLayoutView {
    ...
    [self.arrowImg setImage:[UIImage imageNamed:@"com_more"] forState:UIControlStateNormal];
